...
%% Automobilfederung: 
% Class Name: Automobilfederung
%
% Description: A class to simulate the suspension of a vehicle.
%
% Syntax:  model = Automobilfederung('m1', mass1,...
%    'm2', mass2,...
%    'c1', spring constant 1,...
%    'c2', spring constant 2,...
%    'd2', damping constant 2,...
%    'u', input function);
% Author: Lukas Benner
% DHBW Stuttgart
% data: Q2 2022
    ...
    methods (Access = public)
        ...
        % Runs the simulation with the fourth order Runge-Kutta method.
            t = 0;
            tfinal = 10;
            h = 0.01;
            y = [0; 0; 0; 0];
